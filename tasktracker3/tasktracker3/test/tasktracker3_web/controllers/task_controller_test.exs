defmodule Tasktracker3Web.TaskControllerTest do
  ...
  @create_attrs %{assigned_to: "some assigned_to", completed: true, description: "some description", time_taken: 42, title: "some title"}
  @update_attrs %{assigned_to: "some updated assigned_to", completed: false, description: "some updated description", time_taken: 43, title: "some updated title"}
  @invalid_attrs %{assigned_to: nil, completed: nil, description: nil, time_taken: nil, title: nil}
